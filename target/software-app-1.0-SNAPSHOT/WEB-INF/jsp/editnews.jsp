    ...
    <form method="post" action="/editnews">
        <div class="article col-md-12">
            <div class="input-group input-group-lg edit-title">
                ...
                <input type="text" class="form-control" placeholder="请输入文章标题" aria-describedby="sizing-addon1" value="${news.head}" name="newstitle">
            </div>
            <div class="input-group input-group-lg author">
                <span class="input-group-addon" id="sizing-addon-author" >作者：</span>
                <input type="text" class="form-control" placeholder="请输入文章作者" aria-describedby="sizing-addon1" value="${news.author}" name="newsauthor">
            </div>
            <div class="div-content">
                <textarea class="content" rows="25" placeholder="请输入文章内容" name="content" >${news.news}</textarea>
            </div>
